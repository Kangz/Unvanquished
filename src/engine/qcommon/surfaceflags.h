...
#define SURF_SPLASH \
    0x00000040                      // out of surfaces, so replacing unused 'SURF_FLESH' - and as
...
#define SURF_GLASS \
    0x00200000 // out of surfaces, so replacing unused 'SURF_SMGROUP'
...
#define SURF_MONSTERSLICK \
    0x04000000 // slick surf that only affects AI-controlled entities
