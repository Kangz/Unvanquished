...
/**
 * keyword currently used to mark a line as having to be appended to the log,
 * but not notify about it on the HUD
 */
#define S_SKIPNOTIFY "[skipnotify]"

/**
 * used for consistent representation within print or log statements, that don't
 * use any severity enum yet
 */
...
// func should be defined in global.h or somewhere else in a compiler
// independend manner
...
typedef enum {
    ...
    LOG_INFO = 1,   /*< general helpful (even outside of debugging) but not
                     necessary information */
    LOG_DEBUG = 2,
    LOG_TRACE = 3, /*< this is for finest grained debug-tracing, that should not
                    be executed in NDEBUG */
    LOG_ALL = 4
} log_level_t;
