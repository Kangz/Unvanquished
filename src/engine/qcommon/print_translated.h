...
// Macros required:
//   TRANSLATE_FUNC            - name of the translation function, called from
//   this code
//   PLURAL_TRANSLATE_FUNC     - name of the translation function for plurals,
                    ...
                    if (*in == 't' && *(in + 1) == '$') {
                        ...
                        if (num >= 0 && num < totalArgs) {
                            const char* translated =
                                    TRANSLATE_FUNC(Cmd_Argv(num + firstTextArg));
