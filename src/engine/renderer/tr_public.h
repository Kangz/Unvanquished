...
typedef struct {
    ...
    qhandle_t (*RegisterShader)(const char* name, RegisterShaderFlags_t flags);
    ...
    void (*DrawRotatedPic)(float x, float y, float w, float h, float s1, float t1, float s2, float t2, qhandle_t hShader,
    ...
    int (*BuildSkeleton)(refSkeleton_t* skel, qhandle_t anim, int startFrame, int endFrame, float frac, bool clearOrigin);
    ...
    void (*AddVisTestToScene)(qhandle_t hTest, vec3_t pos, float depthAdjust, float area);
