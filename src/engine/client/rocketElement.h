...
public:
    RocketElement(const Rocket::Core::String& tag)
    ...
    void ProcessEvent(Rocket::Core::Event& event) {
        ...
        if (event.GetTargetElement() == this &&
            !Q_stristr(event.GetType().CString(), "mouse") &&
            !Q_stristr(event.GetType().CString(), "resize")) {
...
public:
    ...
    ~RocketElementInstancer() {}
    Rocket::Core::Element*
    InstanceElement(Rocket::Core::Element* parent,
                    const Rocket::Core::String& tag,
                    const Rocket::Core::XMLAttributes& attributes) {
        return new RocketElement(tag);
    }

    void ReleaseElement(Rocket::Core::Element* element) { delete element; }
