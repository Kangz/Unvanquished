...
#define trap_CM_TransformedBoxTrace(...) \
    CM_TransformedBoxTrace(__VA_ARGS__, TT_AABB)
#define trap_CM_CapsuleTrace(...) CM_BoxTrace(__VA_ARGS__, TT_CAPSULE)
#define trap_CM_TransformedCapsuleTrace(...) \
    CM_TransformedBoxTrace(__VA_ARGS__, TT_CAPSULE)
...
trap_Key_GetKeynumForBinds(int team, std::vector<std::string> binds);
