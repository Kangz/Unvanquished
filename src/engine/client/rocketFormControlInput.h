...
class CvarElementFormControlInput
        : public Rocket::Controls::ElementFormControlInput,
          public Rocket::Core::EventListener {
public:
    CvarElementFormControlInput(const Rocket::Core::String& tag)
            : Rocket::Controls::ElementFormControlInput(tag) {}

    virtual void
    OnAttributeChange(const Rocket::Core::AttributeNameList& changed_attributes) {
        Rocket::Controls::ElementFormControlInput::OnAttributeChange(
                changed_attributes);
    ...
    void UpdateValue() {
        if (!type.Empty()) {
            if (type == "checkbox") {
                ...
                if (Cvar::ParseCvarValue(Cvar::GetValue(cvar.CString()).c_str(),
                                         result)) {
                    if (result) {
...
private:
    void SetCvarValueAndFlags(const Rocket::Core::String& cvar,
