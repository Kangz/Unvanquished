...
class CvarElementFormControlSelect
        : public Rocket::Controls::ElementFormControlSelect,
          public Rocket::Core::EventListener {
public:
    CvarElementFormControlSelect(const Rocket::Core::String& tag)
            : Rocket::Controls::ElementFormControlSelect(tag) {}

    virtual void
    OnAttributeChange(const Rocket::Core::AttributeNameList& changed_attributes) {
        Rocket::Controls::ElementFormControlSelect::OnAttributeChange(
                changed_attributes);
