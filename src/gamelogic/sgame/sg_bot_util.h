...
// when human bots reach this ammo percentage left or less(and no enemy), they
// will head back to the base to refuel ammo
...
// how far away we can be before we try to go around an alien when fighting an
// alien
