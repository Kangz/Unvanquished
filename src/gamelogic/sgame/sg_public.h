...
gentity_t* New(const vec3_t origin, beaconType_t type, int data, team_t team, int owner = ENTITYNUM_NONE, beaconConflictHandler_t conflictHandler = BCH_NONE);
...
gentity_t* FindSimilar(const vec3_t origin, beaconType_t type, int data, int team, int owner, float radius = 128.0f, int eFlags = 0, int eFlagsRelevant = 0);
int RemoveSimilar(const vec3_t origin, beaconType_t type, int data, int team, int owner, float radius = 128.0f, int eFlags = 0, int eFlagsRelevant = 0);
gentity_t* MoveSimilar(const vec3_t from, const vec3_t to, beaconType_t type, int data, int team, int owner, float radius = 128.0f, int eFlags = 0, int eFlagsRelevant = 0);
