...
static void CG_Obituary(entityState_t* ent) {
    ...
    assistantTeam = (team_t)(ent->generic1 &
                             0xFF); // ugly hack allowing for future expansion(!)
    mod = ent->eventParm;
    ...
    if (cg_emoticonsInMessages.integer) {
        ...
        // if the long form is needed, show it; but we need a kill icon for this
        // kill type
    ...
    is_long_kill_message: // <- use of this label == needs a kill icon
        ...
        switch (mod) {
            ...
            case MOD_MGTURRET:
                ...
                messageAssisted =
                        G_("%s%s ^7was gunned down by a turret; %s%s^7 assisted\n");
                break;
            ...
            case MOD_ATUBE:
                ...
                messageAssisted =
                        G_("%s%s ^7was melted by an acid tube; %s%s^7 assisted\n");
                break;

            case MOD_SPIKER:
                message = G_("%s%s ^7was flechetted by a spiker\n");
                messageAssisted =
                        G_("%s%s ^7was flechetted by a spiker; %s%s^7 assisted\n");
                break;

            case MOD_OVERMIND:
                message = G_("%s%s ^7was whipped by the overmind\n");
                messageAssisted =
                        G_("%s%s ^7was whipped by the overmind; %s%s^7 assisted\n");
                break;

            case MOD_REACTOR:
                message = G_("%s%s ^7was fried by the reactor\n");
                messageAssisted =
                        G_("%s%s ^7was fried by the reactor; %s%s^7 assisted\n");
                break;

            case MOD_SLOWBLOB:
                message = G_("%s%s ^7couldn't avoid the granger\n");
                messageAssisted =
                        G_("%s%s ^7couldn't avoid the granger; %s%s^7 assisted\n");
                break;

            case MOD_SWARM:
                message = G_("%s%s ^7was consumed by the swarm\n");
                messageAssisted =
                        G_("%s%s ^7was consumed by the swarm; %s%s^7 assisted\n");
                break;
        ...
        switch (mod) {
            ...
            case MOD_MACHINEGUN:
                ...
                messageAssisted =
                        G_("%s%s ^7was machinegunned by %s%s^7; %s%s^7 assisted\n");
                break;

            case MOD_CHAINGUN:
                message = G_("%s%s ^7was mowed down by %s%s\n");
                messageAssisted =
                        G_("%s%s ^7was mowed down by %s%s^7; %s%s^7 assisted\n");
                break;

            case MOD_SHOTGUN:
                message = G_("%s%s ^7was gunned down by %s%s\n");
                messageAssisted =
                        G_("%s%s ^7was gunned down by %s%s^7; %s%s^7 assisted\n");
                break;

            case MOD_PRIFLE:
                message = G_("%s%s ^7was seared by %s%s^7's pulse blast\n");
                messageAssisted =
                        G_("%s%s ^7was seared by %s%s^7's pulse blast; %s%s^7 assisted\n");
                break;
            ...
            case MOD_FLAMER_SPLASH:
                ...
                messageAssisted =
                        G_("%s%s ^7was grilled by %s%s^7's flame; %s%s^7 assisted\n");
            ...
            case MOD_BURN:
                ...
                messageAssisted =
                        G_("%s%s ^7was burned by %s%s^7's fire; %s%s^7 assisted\n");
            ...
            case MOD_LCANNON:
                ...
                messageAssisted =
                        G_("%s%s ^7was annihilated by %s%s^7's plasma blast; %s%s^7 "
                           "assisted\n");
                break;
            ...
            case MOD_LCANNON_SPLASH:
                ...
                messageAssisted =
                        G_("%s%s ^7was irradiated by %s%s^7's plasma blast; %s%s^7 "
                           "assisted\n");
            ...
            case MOD_GRENADE:
                ...
                messageAssisted =
                        G_("%s%s ^7was blown up by %s%s^7's grenade; %s%s^7 assisted\n");
            ...
            case MOD_FIREBOMB:
                ...
                messageAssisted = G_(
                        "%s%s ^7was incinerated by %s%s^7's firebomb; %s%s^7 assisted\n");
            ...
            case MOD_ABUILDER_CLAW:
                ...
                messageAssisted = G_(
                        "%s%s ^7was gently nibbled by %s%s^7's granger; %s%s^7 assisted\n");
                break;
            ...
            case MOD_LEVEL1_CLAW:
                ...
                messageAssisted =
                        G_("%s%s ^7was sliced by %s%s^7's %s^7; %s%s^7 assisted\n");
            ...
            case MOD_LEVEL2_CLAW:
                ...
                messageAssisted =
                        G_("%s%s ^7was shredded by %s%s^7's %s^7; %s%s^7 assisted\n");
            ...
            case MOD_LEVEL2_ZAP:
                ...
                messageAssisted =
                        G_("%s%s ^7was electrocuted by %s%s^7's %s^7; %s%s^7 assisted\n");
                attackerClass = PCL_ALIEN_LEVEL2;
                break;
            ...
            case MOD_LEVEL3_CLAW:
                ...
                messageAssisted =
                        G_("%s%s ^7was chomped by %s%s^7's %s^7; %s%s^7 assisted\n");
            ...
            case MOD_LEVEL3_POUNCE:
                ...
                messageAssisted =
                        G_("%s%s ^7was pounced upon by %s%s^7's %s^7; %s%s^7 assisted\n");
                attackerClass = PCL_ALIEN_LEVEL3;
                break;
            ...
            case MOD_LEVEL3_BOUNCEBALL:
                ...
                messageAssisted =
                        G_("%s%s ^7was barbed by %s%s^7's %s^7; %s%s^7 assisted\n");
            ...
            case MOD_LEVEL4_CLAW:
                ...
                messageAssisted =
                        G_("%s%s ^7was mauled by %s%s^7's %s^7; %s%s^7 assisted\n");
                attackerClass = PCL_ALIEN_LEVEL4;
                break;

            case MOD_LEVEL4_TRAMPLE:
                message =
                        G_("%s%s ^7should have gotten out of the way of %s%s^7's %s\n");
                messageAssisted =
                        G_("%s%s ^7should have gotten out of the way of %s%s^7's %s^7; "
                           "%s%s^7 assisted\n");
                attackerClass = PCL_ALIEN_LEVEL4;
                break;
            ...
            case MOD_WEIGHT_A:
                ...
                messageAssisted =
                        G_("%s%s ^7was crushed under %s%s^7's weight; %s%s^7 assisted\n");
                break;

            case MOD_POISON:
                message =
                        G_("%s%s ^7should have used a medkit against %s%s^7's poison\n");
                messageAssisted =
                        G_("%s%s ^7should have used a medkit against %s%s^7's poison; "
                           "%s%s^7 assisted\n");
                break;
        ...
        if (message) {
            ...
            if (attackerClass == -1) {
                *attackerClassName = 0;
                ...
                Q_strncpyz(attackerClassName,
                           _(BG_ClassModelConfig(attackerClass)->humanName),
                           sizeof(attackerClassName));
            }

            // Argument order: victim, attacker, [class,] [assistant]. Each has team
            // tag first.
...
void CG_PainEvent(centity_t* cent, int health) {
    ...
    trap_S_StartSound(nullptr, cent->currentState.number, CHAN_VOICE, CG_CustomSound(cent->currentState.number, snd));
...
void CG_OnPlayerWeaponChange(weapon_t oldWeapon) {
    ...
    if (trap_Key_GetCatcher() == KEYCATCH_UI &&
        ps->persistant[PERS_TEAM] == TEAM_HUMANS) {
    ...
    cg.predictedPlayerEntity.pe.weapon.animationNumber =
            -1; // force weapon lerpframe recalculation
}
...
void CG_EntityEvent(centity_t* cent, vec3_t position) {
    ...
    switch (event) {
        case EV_FOOTSTEP:
            if (cg_footsteps.integer && ci->footsteps != FOOTSTEP_NONE) {
                if (ci->footsteps == FOOTSTEP_CUSTOM) {
                    trap_S_StartSound(nullptr, es->number, CHAN_BODY, ci->customFootsteps[rand() & 3]);
                } else {
                    trap_S_StartSound(nullptr, es->number, CHAN_BODY, cgs.media.footsteps[ci->footsteps][rand() & 3]);
                }
            }
        ...
        case EV_FOOTSTEP_METAL:
            if (cg_footsteps.integer && ci->footsteps != FOOTSTEP_NONE) {
                if (ci->footsteps == FOOTSTEP_CUSTOM) {
                    trap_S_StartSound(nullptr, es->number, CHAN_BODY, ci->customMetalFootsteps[rand() & 3]);
                } else {
                    trap_S_StartSound(nullptr, es->number, CHAN_BODY, cgs.media.footsteps[FOOTSTEP_METAL][rand() & 3]);
                }
            }
        ...
        case EV_FOOTSTEP_SQUELCH:
            if (cg_footsteps.integer && ci->footsteps != FOOTSTEP_NONE) {
                trap_S_StartSound(nullptr, es->number, CHAN_BODY, cgs.media.footsteps[FOOTSTEP_FLESH][rand() & 3]);
            }
        ...
        case EV_FOOTSPLASH:
            if (cg_footsteps.integer && ci->footsteps != FOOTSTEP_NONE) {
                trap_S_StartSound(nullptr, es->number, CHAN_BODY, cgs.media.footsteps[FOOTSTEP_SPLASH][rand() & 3]);
            }
        ...
        case EV_WEAPON_RELOAD:
            if (cg_weapons[es->eventParm].wim[WPM_PRIMARY].reloadSound) {
                trap_S_StartSound(
                        nullptr, es->number, CHAN_WEAPON, cg_weapons[es->eventParm].wim[WPM_PRIMARY].reloadSound);
            }
            break;
        ...
        case EV_DEATH2:
        case EV_DEATH3:
            trap_S_StartSound(nullptr, es->number, CHAN_VOICE, CG_CustomSound(es->number, va("*death%i.wav", event - EV_DEATH1 + 1)));
            break;
        ...
        case EV_OVERMIND_ATTACK_2:
            if (cg.predictedPlayerState.persistant[PERS_TEAM] == TEAM_ALIENS) {
                ...
                CG_CenterPrint(va("^%c%s", "31"[event - EV_OVERMIND_ATTACK_1], _("The Overmind is under attack!")),
                               200,
                               GIANTCHAR_WIDTH * 4);
            }
        ...
        case EV_REACTOR_ATTACK_2:
            if (cg.predictedPlayerState.persistant[PERS_TEAM] == TEAM_HUMANS) {
                CG_CenterPrint(va("^%c%s", "31"[event - EV_REACTOR_ATTACK_1], _("The reactor is under attack!")),
                               200,
                               GIANTCHAR_WIDTH * 4);
            }
        ...
        case EV_WARN_ATTACK:
            // if eventParm is non-zero, this is for humans and there's a nearby
            // reactor or repeater, otherwise it's for aliens
            if (es->eventParm >= MAX_CLIENTS && es->eventParm < MAX_GENTITIES) {
                const char* location;
                bool base =
                        cg_entities[es->eventParm].currentState.modelindex == BA_H_REACTOR;
                centity_t* locent =
                        CG_GetLocation(cg_entities[es->eventParm].currentState.origin);

                CG_CenterPrint(base ? _("Our base is under attack!")
                                    : _("A forward base is under attack!"),
                               200,
                               GIANTCHAR_WIDTH * 4);

                if (locent) {
                    location =
                            CG_ConfigString(CS_LOCATIONS + locent->currentState.generic1);
                } else {
        ...
        case EV_ALIEN_ACIDTUBE: {
            particleSystem_t* ps =
                    CG_SpawnNewParticleSystem(cgs.media.alienAcidTubePS);
        ...
        case EV_ALIEN_BOOSTER: {
            particleSystem_t* ps =
                    CG_SpawnNewParticleSystem(cgs.media.alienBoosterPS);
